...
import {useAddSales} from '@/app/(root)/components/hooks/useProducts';
...
const AddSaleButton = ({onAddSale}: {onAddSale: (productName: string) => void}) => {
...
const AddSaleModal = ({
  ...
  handleClose: () => void;
  onAddSale: (productName: string) => void;
}) => {
  ...
  const handleCreateProduct = useCallback(async () => {
    ...
    onAddSale(name);
    handleClose();
  }, [onAddSale, addProducts, imageName, multipleSizes, name, handleClose]);
